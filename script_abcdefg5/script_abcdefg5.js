...
const translations = {
    'zh-CN': {
        ...
        // Corporate Profile
        'corp-profile-title': '会社概要',
        'corp-profile-name-label': '会社名',
        'corp-profile-name-value': '東森株式会社',
        'corp-profile-address-label': '会社住所',
        'corp-profile-address-value': '東京都墨田区立花四丁目23番7号椎葉ビル302号室',
        'corp-profile-established-label': '設立',
        'corp-profile-established-value': '令和4年6月13日',
        'corp-profile-capital-label': '資本金',
        'corp-profile-capital-value': '1億円',
        'corp-profile-representative-label': '代表取缔役',
        'corp-profile-representative-value': '李 涛',
        ...
        'corp-profile-tel-value': '03-5356-7810',
        'corp-profile-fax-label': 'FAX',
    ...
    'zh-TW': {
        ...
        'corp-profile-name-label': '會社名',
        'corp-profile-name-value': '東森株式會社',
        'corp-profile-address-label': '會社住所',
        'corp-profile-address-value': '東京都墨田區立花四丁目23番7號椎葉ビル302號室',
        'corp-profile-established-label': '設立',
        'corp-profile-established-value': '令和4年6月13日',
        'corp-profile-capital-label': '資本金',
        'corp-profile-capital-value': '1億円',
        'corp-profile-representative-label': '代表取締役',
        'corp-profile-representative-value': '李 濤',
        'corp-profile-employees-label': '従業員',
        'corp-profile-employees-value': '***',
    ...
    en: {
        ...
        // Corporate Nav/Hero
        'nav-corporate': 'Company Profile',
        'corp-title': 'TOUSIN - Corporate',
        'corp-catch': 'In this moment, together with TOUSIN.',
        'corp-sub': '— Sharing your precious moments in Japan.',

        // Corporate Profile
        'corp-profile-title': 'Company Profile',
        'corp-profile-name-label': 'Company Name',
        'corp-profile-name-value': 'TOUSIN Co., Ltd.',
        'corp-profile-address-label': 'Address',
        'corp-profile-address-value': '302 Shiiwa Building, 23-7 Tachibana 4-chome, Sumida-ku, Tokyo',
        'corp-profile-established-label': 'Established',
        'corp-profile-established-value': 'June 13, 2022 (Reiwa 4)',
        'corp-profile-capital-label': 'Capital',
        'corp-profile-capital-value': '100 million yen',
        'corp-profile-representative-label': 'Representative Director',
        'corp-profile-representative-value': 'Li Tao',
